...
# # Define the secret key and token expiration time (you can adjust the expiration time as needed)
...
#         access_token = create_access_token(data={"sub": user["UserName"], "email": user["Email"]})
#         print(access_token)
#         return JSONResponse(content={"access_token": access_token, "redirect_url": "/Dashboard"})
    
#     else:
#         return templates.TemplateResponse("sign.html", {"request": request, "message": "Invalid Email or Password!"})
